...
Phase 6 through Phase 10 store local memory, semantic indexes, agent traces,
predictive/self-healing audit-derived state, installed plugin manifests, and
plugin trust/lifecycle state under the configured state directory. Those runtime
